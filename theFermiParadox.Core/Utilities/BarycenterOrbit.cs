...
{
    public class BarycenterOrbit : IOrbit
    {
        ...
        protected BarycenterOrbit(ABody virtualBody, ABody body) 
        {
            _virtualBody = virtualBody;
            _body = body;
        }
        ...
        public ABody MainBody { get => _virtualBody; }
